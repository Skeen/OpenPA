...
class TestParser(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ['"key1" value1\n"key2" value2', {'key1': 'value1', 'key2': 'value2'}],
        ['"key with space" value1\nkey2 value2', {'key with space': 'value1', 'key2': 'value2'}],
        # Simple sections
        ["BEGIN section alfa beta END", {'section': {'alfa': 'beta'}}],
        ["  BEGIN   section   alfa   beta   END  ", {'section': {'alfa': 'beta'}}],
        ['BEGIN section "key with spaces" beta END', {'section': {'key with spaces': 'beta'}}],
        ['BEGIN "section with spaces" alfa beta END', {'section with spaces': {'alfa': 'beta'}}],
        ['BEGIN "section with spaces" "key with spaces" beta END', {'section with spaces': {'key with spaces': 'beta'}}],
        # Nested sections
        ["BEGIN outer-section BEGIN inner-section alfa beta END END", {'outer-section': {'inner-section': {'alfa': 'beta'}}}],
    ])
